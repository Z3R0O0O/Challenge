        ...
        for processo in psutil.process_iter(attrs=['pid', 'name', 'cpu_percent']):
            try:
                ...
                if (
                    ...
                    print(f"Processo {nome_processo} (PID {pid}) está usando mais de {limite_cpu}% da CPU. Encerrando com SIGTERM.")
                    ...
                    if processo.is_running():
                        print(f"Processo {nome_processo} (PID {pid}) não respondeu ao SIGTERM. Encerrando com SIGKILL.")
